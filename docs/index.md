...
| 席次表の公開 | 9,800円（税込） | 基本料金。お支払いは一度だけ。 |
| エスコートカードの印刷 | 2,200円（税込） | オプション費用。100枚単位。再依頼を行う場合は再度お支払いいただく必要がございます。 |
| フォトギャラリーアップグレード | 2,200円（税込） | オプション費用。画像登録枠が5枚から50枚に拡張されます。 |
| 席次表画像のダウンロード | 1,000円（税込） | オプション費用。同じ席次表であれば追加料金なしで再ダウンロードできます。 |
